...
class PPYOLOEATSSAssigner(BaseAssigner):
    def __init__(self,
                 topk,
    ...
    def assign(self,
        ...
        if decoded_bboxes is not None:
            # pred_overlaps = self.iou_calculator(gt_bboxes, decoded_bboxes) * overlaps_inf.gt(0).t()
            # max_overlaps[pos_idx] = pred_overlaps.max(0)[0][pos_idx]
